 ...
 */
@Slf4j
public class PIDCmdAction extends AbstractCmdAction {

    public static String NAME = CmdConstant.PROCESS_ID;

    private String prefix = "ps -ef";

    private String suffix = "| grep -v grep | awk '{print $2}'";
    ...
    public void doAction(CmdEvent event) {
        ...
        if (result.endsWith("\r\n")) {
            event.setResult(result.subSequence(0, result.lastIndexOf("\r\n")));
        } else {
