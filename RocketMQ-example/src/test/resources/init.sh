...
if [ ! -d "/root/rocketmq-all-4.3.2/distribution/target/apache-rocketmq/" ];then
    cd /root/rocketmq-all-4.3.2/
    sed -i "s\-server -Xms8g -Xmx8g -Xmn4g\-server -Xms4g -Xmx4g -Xmn4g\g" /root/rocketmq-all-4.3.2/distribution/target/apache-rocketmq/bin/runbroker.sh
